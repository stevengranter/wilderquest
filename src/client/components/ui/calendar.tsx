    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                month: 'space-y-4',
                caption:
                    'flex justify-center text-mtext pt-1 relative items-center',
                ...
                head_row: 'flex',
                head_cell:
                    'text-mtext rounded-base w-9 font-base text-[0.8rem]',
                ...
                day_outside:
                    'day-outside text-mtext opacity-50 aria-selected:bg-none',
                day_disabled: 'text-mtext opacity-50 rounded-base',
                day_range_middle:
                    'aria-selected:bg-white aria-selected:text-mtext',
