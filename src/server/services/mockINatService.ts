...
const mockTaxa: INatTaxon[] = [
    ...
    },
    {
        ...
        default_photo: {
            id: 11,
            license_code: 'CC-BY',
            attribution: 'Mock Great Blue Heron Photo',
            url: 'https://via.placeholder.com/500x500?text=Great+Blue+Heron',
            original_dimensions: { height: 500, width: 500 },
            flags: [],
            attribution_name: null,
            square_url:
                'https://via.placeholder.com/100x100?text=Great+Blue+Heron',
            medium_url:
                'https://via.placeholder.com/300x300?text=Great+Blue+Heron',
        },
        taxon_changes_count: 0,
        taxon_schemes_count: 0,
